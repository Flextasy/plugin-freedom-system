...
**Goal:** Implement the 3 unique features that differentiate Fracture
...
2. **HTML/CSS Layout**
   - Header bar: Title ("FRACTURE"), subtitle ("GRANULAR DELAY"), Freeze button, Dry/Wet knob
   - Body: 5 sections (Delay, Grain, Character, Fracture, Mix)
