# Fracture v3 UI Integration Checklist
...
- [ ] **Copy C++ header template**
  ...
  - Update processor class name if different from `FractureProcessor`
...
- [ ] **Verify build artifacts**
  - VST3: `build/Fracture_artefacts/Release/VST3/Fracture.vst3`
  - AU (macOS): `build/Fracture_artefacts/Release/AU/Fracture.component`
  - Standalone: `build/Fracture_artefacts/Release/Standalone/Fracture`
...
- [ ] **Visual checks**
  ...
  - All 5 sections visible (Delay, Grain, Character, Fracture, Mix)
...
- **Check BinaryData**: Verify `index.html` is embedded correctly
  ...
  ```
- **Check URL**: Verify base URL matches `juce::URL("https://fracture.local")`
