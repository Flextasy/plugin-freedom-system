// Fracture Plugin Editor — WebView Implementation (JUCE 8)
    ...
    : AudioProcessorEditor (&p), processorRef (p)
{
    ...
    webView->goToURL ("https://fracture.local/index.html");
...
std::optional<juce::WebBrowserComponent::Resource> FractureEditor::getResource (const juce::String& url)
{
